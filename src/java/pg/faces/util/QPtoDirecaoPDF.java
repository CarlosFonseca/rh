...
public class QPtoDirecaoPDF {
    ...
    public String exportaQP(FacesContext facesContext,  String filename, String direccao, List<QPDirecao> listQPDirecao ) throws IOException {
          //aqui
        if (listQPDirecao.isEmpty()){
            ...
            try {
                ...
                Logger.getLogger(QPtoDirecaoPDF.class.getName()).log(Level.SEVERE, null, ex);
            }
           ...
           try {
                ...
                tableMaster.setHeaderRows(2);
                PdfPTable table = getTable(listQPDirecao);     //Gera tabela das estruturas 
    ...
    private PdfPTable getTable(List<QPDirecao> listQPDirecao){
        ...
        while(it.hasNext()){
         ...
         if((qpd.getCdEstrutura() != cdEstrutura) && (cdEstrutura != 0)){
        ...
        if(cdEstrutura != qpd.getCdEstrutura()){
            ...
            table.addCell(new Phrase(qpd.getEstruturaDsComp(), fonteSbuTitulo));
         ...
         if (qpd.getNre()!= null)
            addColumnValue(table,qpd.getNre().toString(),font,Element.ALIGN_RIGHT);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         
         if (qpd.getNomeRedz()!= null)         
         addColumnValue(table,qpd.getNomeRedz(),font,Element.ALIGN_LEFT);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         
         if (qpd.getDtNasc()!= null)
         addColumnValue(table,df.format(qpd.getDtNasc()),font,Element.ALIGN_CENTER);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         if (qpd.getDtAdmiss()!= null)
         addColumnValue(table,df.format(qpd.getDtAdmiss()),font,Element.ALIGN_CENTER);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         if (qpd.getHabDsRedz()!= null)
         addColumnValue(table,qpd.getHabDsRedz(),font,Element.ALIGN_LEFT);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         if (qpd.getCdGrupo()!= null)
         addColumnValue(table,qpd.getCdGrupo(),font,Element.ALIGN_CENTER);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         if (qpd.getCdNivel()!= null)
         addColumnValue(table,qpd.getCdNivel()+"" ,font,Element.ALIGN_CENTER);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         if (qpd.getDtNivel()!= null)
         addColumnValue(table,df.format(qpd.getDtNivel()),font,Element.ALIGN_CENTER);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         if (qpd.getNre()!= null)
         addColumnValue(table,getIHT(qpd.getNre()),font,Element.ALIGN_CENTER);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         if (qpd.getFuncaoDsComp()!= null)
         addColumnValue(table,qpd.getFuncaoDsComp(),font,Element.ALIGN_LEFT);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         if (qpd.getFuncIntDsComp()!= null)
         addColumnValue(table,qpd.getFuncIntDsComp(),font,Element.ALIGN_LEFT);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         if (qpd.getSituacaoDsRedz()!= null)
         addColumnValue(table,qpd.getSituacaoDsRedz(),font,Element.ALIGN_LEFT);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);

         if (qpd.getSiglaE()!= null)
         addColumnValue(table,qpd.getSiglaE(),font,Element.ALIGN_LEFT);
         else 
            addColumnValue(table,"",font,Element.ALIGN_LEFT);
    ...
    //------------------------------------------------------------ 
         if (qpd.getCdFuncao()!= null)
          ...
          if(qpd.getCdEstrutura() == cdEstrutura){
              ...
              empregados += 1;
              totalEmpregados += 1;
///              quadro = ie.getQacEstruturasFicticia().getPontuacao();
              
             if ((qpd.getCdSituacao() !=21) && (!cdFuncao.equals("SL"))){
                    total += 1;
                    totalTotal += 1;
             }
